...
public abstract class Button extends BaseMaterialView {
    ...
    protected void setDefaultProperties() {
        // Min size
        setMinimumHeight(FiskInfoUtility.dpToPx(minHeight, getResources()));
        setMinimumWidth(FiskInfoUtility.dpToPx(minWidth, getResources()));
        // Background shape
    ...
    @SuppressLint("MissingSuperCall") //Not required in this case
    @Override
    ...
    public Bitmap makeCircle() {
        Bitmap output = Bitmap.createBitmap(
                getWidth() - FiskInfoUtility.dpToPx(6, getResources()), getHeight()
                        - FiskInfoUtility.dpToPx(7, getResources()), Config.ARGB_8888);
