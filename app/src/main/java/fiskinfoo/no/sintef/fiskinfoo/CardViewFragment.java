...
public class CardViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (propertyDescription != null) {
            ...
            TextView dataOwnerView = generateTextViewWithText("Data eier: " + propertyDescription.DataOwner, longDescriptionView);
            TextView dataOwnerLinkView = generateTextViewWithText("Data eier sin addresse: " + propertyDescription.DataOwnerLink, dataOwnerView);
